...
select_button = tk.Button(root, text="Posição", command=Rastromouse)
...
paste_button = tk.Button(root, text="Iniciar", command=paste_from_excel)
paste_button.grid(row=2, column=2, columnspan=2, padx=5, pady=5)

status_label = tk.Label(root, text="", fg="black")
status_label.grid(row=3, column=1, columnspan=1, padx=2, pady=2)
